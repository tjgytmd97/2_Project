...
public class Certificate {
	...
	public Certificate(String certi_num, String certi_name, String certi_hndw_rcp_start_date,
			...
			String certi_hndw_pass_start_date, String certi_hndw_pass_end_date, String certi_prctc_rcp_start_date,
			String certi_prctc_rcp_end_date, String certi_prctc_test_start_date, String certi_prctc_test_end_date,
			String certi_final_pass_start_date, String certi_final_pass_end_date) {
		super();
