	...
	<section id="wrapper">
		<div class="content">
			...
			<div class="tabs">
				...
				<button class="tablinks" data-country="웹디자인">
					<p data-title="웹디자인">웹디자인</p>
				</button>
				<button class="tablinks" data-country="클라우드">
					<p data-title="클라우드">클라우드</p>
				</button>
				<button class="tablinks" data-country="공용">
					<p data-title="공용">공용</p>
				</button>
			</div>
			...
			<div>
				...
				<div id="네트워크및보안" class="tabcontent">
					...
					<p>
						...
						<button type="submit" name="certi_name" value="CCT">CCT</button>
				...
				<div id="데이터베이스" class="tabcontent">
					<h3>데이터베이스</h3>
					<p>
						...
						<button type="submit" name="certi_name"
							value="DSAC 데이터 사이언티스트 능력인증자격">DSAC 데이터 사이언티스트 능력인증자격</button>
				...
				<div id="클라우드" class="tabcontent">
					<h3>클라우드</h3>
					<p>
						<button type="submit" name="certi_name" value="AWS">AWS</button>
						<button type="submit" name="certi_name" value="AZURE">AZURE
						</button>
						<button type="submit" name="certi_name" value="GCP">GCP</button>
						<button type="submit" name="certi_name"
						...
						<button type="submit" name="certi_name" value="OCA">OCA</button>
						<button type="submit" name="certi_name" value="OCM">OCM</button>
						<button type="submit" name="certi_name" value="OCP">OCP</button>
					</p>
				</div>

				<div id="공용" class="tabcontent">
					<h3>공용</h3>
					<p>
						...
						<button type="submit" name="certi_name" value="IT Plus">IT
							Plus</button>
						<button type="submit" name="certi_name" value="PAC(프레젠테이션능력인증자격)">PAC(프레젠테이션능력인증자격)</button>
